...
import 'package:gemini/Models/messages_Model.dart'; // Assuming this is your model import
...
class _BotPageState extends State<BotPage> {
  ...
  Future<void> sendMessage() async {
    ...
    // Corrected the usage of clear() method
    _userMessage.clear();

    // Added a null check for the message
    if (msg.isNotEmpty) {
      setState(() {
        _messagesList
